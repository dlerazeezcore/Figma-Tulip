    ...
    <div className="min-h-full bg-gradient-to-b from-gray-50 to-white dark:from-background dark:to-background flex flex-col">
      ...
      <header className="relative bg-gradient-to-br from-[#1967D2] via-[#1557B0] to-[#114A99] text-white px-6 pt-12 pb-8 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-2xl mb-1">Hotel Bookings</h1>
          <p className="text-sm text-white/90">Your hotel reservations</p>
        </div>
      </header>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-sm w-full text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-muted-foreground mb-8 leading-relaxed">
            You haven't made any hotel reservations yet. Your future bookings will be displayed here for quick reference.
          </p>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-muted dark:to-muted/80 border border-blue-100 dark:border-border mb-8">
            ...
            <div className="text-left">
              <p className="text-xs text-gray-600 dark:text-muted-foreground">Hotel Booking</p>
          ...
          <div className="bg-white dark:bg-card rounded-2xl shadow-md p-6 mb-6">
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-700 dark:text-foreground">Browse thousands of hotels worldwide</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0"></div>
                <p className="text-sm text-gray-700 dark:text-foreground">Exclusive member rates and deals</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-primary mt-1.5 flex-shrink-0"></div>
                <p className="text-sm text-gray-700 dark:text-foreground">Flexible cancellation options</p>
              </div>
            </div>
          </div>
